                        ...
                        <Col md={8} lg={6} xl={5}>
                                    ...
                                    <Row>
                                        <Col className="col-7">
                                            <div className="text-primary p-4">
                                                ...
                                                <p>Sign in to continue to Xymatic dashboard.</p>
                                            </div>
                                        </Col>
                                    ...
                                    <div className="p-2">
                                        ...
                                        <AvForm className="form-horizontal" onValidSubmit={(e, v) => {
                                            ...
                                            <div className="form-group">
                                                <AvField name="email" label="Email" value="eve.holt@reqres.in"
                                                         className="form-control" placeholder="Enter email" type="email"
                                                         required/>
                                            </div>

                                            <div className="form-group">
                                                <AvField name="password" label="Password" value="cityslicka" type="password"
                            ...
                            <div className="mt-5 text-center">
                                <p>Don't have an account ? <Link to="register"
                                    ...
                                    now </Link></p>
                                <p>© {new Date().getFullYear()} Xymatic. Coding Challenge by Vladimir Lukyanov</p>
                            </div>
                        </Col>
                    </Row>
                </Container>
