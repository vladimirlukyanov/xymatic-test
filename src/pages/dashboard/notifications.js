                            ...
                            <ul className="list-group">
                                <li className="list-group-item">
                                    <Media>
                                        ...
                                        <Media body>
                                            ...
                                            <p className="text-muted">If several languages coalesce, the grammar of the
                                                resulting language
                                            </p>
                                ...
                                <li className="list-group-item">
                                    <Media>
                                        ...
                                        <Media body>
                                            <h5 className="font-size-14">Cras ultricies mi eu turpis</h5>
                                            <p className="text-muted">To an English person, it will seem like simplified
                                ...
                                <li className="list-group-item">
                                    <Media>
                                        ...
                                        <Media body>
                                            <h5 className="font-size-14">Duis arcu tortor suscipit</h5>
                                            <p className="text-muted">It va esser tam simplic quam occidental in fact,
                                                it va esser occidental.
                                            </p>
