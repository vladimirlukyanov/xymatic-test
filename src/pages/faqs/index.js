                                            ...
                                            <TabPane tabId="1">
                                                ...
                                                <Media className="faq-box mb-4">
                                                    ...
                                                    <Media body>
                                                        ...
                                                        <p className="text-muted">New common language will be more
                                                            simple and regular than the existing European languages. It
                                                            will be as simple as occidental.</p>
                                                    </Media>
                                                </Media>
                                                <Media className="faq-box mb-4">
                                                    <div className="faq-icon mr-3">
                                                    ...
                                                    <Media body>
                                                        ...
                                                        <p className="text-muted">Everyone realizes why a new common
                                                ...
                                                <Media className="faq-box mb-4">
                                                    ...
                                                    <Media body>
                                                        ...
                                                        <p className="text-muted">If several languages coalesce, the
                                                ...
                                                <Media className="faq-box mb-4">
                                                    ...
                                                    <Media body>
                                                        ...
                                                        <p className="text-muted">Their separate existence is a myth.
                                                ...
                                                <Media className="faq-box">
                                                    ...
                                                    <Media body>
                                                        <h5 className="font-size-15">Where can I get some?</h5>
                                                        <p className="text-muted">To an English person, it will seem
